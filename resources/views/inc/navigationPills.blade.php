<div class="col-md-8">
    ...
    <div class="nav-tabs-navigation">
        <div class="nav-tabs-wrapper">
            <ul id="tabs" class="nav nav-tabs" role="tablist">
                <li class="nav-item">
              <a class="nav-link active text-info" data-toggle="tab" href="#home" role="tab"><strong>Unsual travel</strong></a>
    ...
    <div id="my-tab-content" class="tab-content text-center">
        <div class="tab-pane active" id="home" role="tabpanel"><p>
          ...
          <div class="card">
   <img class="card-img-top" src="ui_assets\img\federico-beccari.jpg" alt="Card image cap">
