<div class="list-content clearfix">
				 ...
				 @foreach ($longTerms as $key => $longTerm)
					<div class="list-item-entry">
							<a href="/tailor-made-trip/">
								...
								<div class="table-view">
										<div class="radius-top cell-view">
											<a href="/rent/{{$longTerm->whatIsItFor}}/{{$longTerm->slug}}">
                      ...
                      <b><a href="/rent/{{$longTerm->whatIsItFor}}/{{$longTerm->slug}}"> {{$longTerm->rentTitle}}</a></b>
											...
											<div class="buttons-block">
												<a href="/rent/{{$longTerm->whatIsItFor}}/{{$longTerm->slug}}" class="c-button b-40 bg-white hv-transparent fr" style="background:#ff6600; border:#ff6600;">View More</a>
											</div>
											</center>
										</div>
