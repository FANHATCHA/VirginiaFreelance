...
<head>
	<meta charset="utf-8"/>
	<title>Travel with a local expert</title>
	...
	<link href="ux/assets/plugins/socicon/socicon.css" rel="stylesheet" type="text/css"/>
	<link href="ux/assets/plugins/bootstrap-social/bootstrap-social.css" rel="stylesheet" type="text/css"/>

	<link href="ux/assets/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css"/>
	<link href="ux/assets/plugins/animate/animate.min.css" rel="stylesheet" type="text/css"/>
	<link href="ux/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
	...
	<!-- END GLOBAL MANDATORY STYLES -->
			...
			<!-- BEGIN: BASE PLUGINS  -->
			<link href="ux/assets/plugins/cubeportfolio/css/cubeportfolio.min.css" rel="stylesheet" type="text/css"/>
			<link href="ux/assets/plugins/owl-carousel/assets/owl.carousel.css" rel="stylesheet" type="text/css"/>
			<link href="ux/assets/plugins/fancybox/jquery.fancybox.css" rel="stylesheet" type="text/css"/>
			<link href="ux/assets/plugins/slider-for-bootstrap/css/slider.css" rel="stylesheet" type="text/css"/>
				<!-- END: BASE PLUGINS -->


    <!-- BEGIN THEME STYLES -->
	<link href="ux/assets/demos/default/css/plugins.css" rel="stylesheet" type="text/css"/>
	<link href="ux/assets/demos/default/css/components.css" id="style_components" rel="stylesheet" type="text/css"/>
	<link href="ux/assets/demos/default/css/themes/default.css" rel="stylesheet" id="style_theme" type="text/css"/>
	<link href="ux/assets/demos/default/css/custom.css" rel="stylesheet" type="text/css"/>
	<!-- END THEME STYLES -->

	<link rel="shortcut icon" href="favicon.ico"/>
</head>
<body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-topbar c-layout-header-topbar-collapse" style="overflow-x: hidden;">
	...
	<div class="container">
		...
		<nav class="c-top-menu c-pull-left">
			<ul class="c-icons c-theme-ul">
				<li><span style="font-weight:bold; font-size:25px; color:black;"><i class="fa fa-phone" aria-hidden="true" style="color:#ff6600;"></i> +99890345677</span></li>
			</ul>
		</nav>
		<!-- END: INLINE NAV -->
		<!-- BEGIN: INLINE NAV -->
		<nav class="c-top-menu c-pull-right">
			...
			<ul class="c-ext c-theme-ul">
				<li class="c-lang dropdown c-last">
					<a href="#"><img src="ux/assets/img/english.png" alt=" Nouvini Travel English"></a>
		...
		<div class="c-navbar-wrapper">
			<div class="c-brand c-pull-left">
				<a href="/" class="c-logo">
					...
					<img src="ux/assets/base/img/layout/logos/logo_nv.png" alt="Nouvini Travel" class="c-desktop-logo-inverse"  width="50px">
					<img src="ux/assets/base/img/layout/logos/logo_nv.png" alt="Nouvini Travel" class="c-mobile-logo"  width="50px">
				</a>
...
<div class="c-layout-go2top">
	...
	<!-- END: CORE PLUGINS -->
			...
			<script src="ux/assets/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js" type="text/javascript"></script>
