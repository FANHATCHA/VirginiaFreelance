...
<body data-color="theme-1">
  ...
  <header class="menu-3 type-5">
   <div class="top-header-bar">
  	  <div class="container">
  	  	 	<div class="left-col">
  	  	 	  ...
  	  	 	  <a href="#"><i class="fa fa-suitcase"></i>Join the Travel</a>
  	  	 	  <a href="#"><i class="fa fa-envelope "></i>Sign in</a>
  	  	 	</div>
  	  	 	<div class="right-col">
  	  	 	    <div class="folow">
  	  	 		...
  	  	 		<form action="http://demo.nrgthemes.com/projects/travel/menu_style_6.html?" class="serach-item">
   ...
   <div class="container">
   	  <div class="row">
   	  	 <div class="col-md-12">
   	  	    <a href="index.html" class="logo">
   	  	    	<img src="img/theme-1/logo.png" alt="lets travel">
   	  	    </a>
     ...
     <div class="clip">
		<div class="bg bg-bg-chrome" style="background-image:url(ui/img/home_2/cc-showcase-background.jpg)">
		</div>
	 </div>
		 ...
		 <div class="row isotope-container">
			 ...
			 <div class="item col-xs-12 col-md-6">
				 <div class="tour-block tour-block-s-2 radius-5 hover-blue">
						 ...
						 <img class="center-image" src="ui/img/home_4/tour-block_1.jpg" alt="">
				 ...
				 <div class="tour-block tour-block-s-4 radius-5 underline-block hover-blue">
						 <div class="tour-layer delay-1"></div>
					 <img class="center-image" src="ui/img/home_4/tour-block_4.jpg" alt="">
					 <div class="tour-caption">
							 <div class="vertical-top">
							 <div class="weth-icon fr">
								 <img src="ui/img/weather_icon_small.png" alt="">
								 <b>+30<sup>o</sup>C</b>
							 </div>
						 </div>
						 <div class="vertical-align">
						 ...
						 <div class="fl">
							 <div class="tour-info">
								 <img src="ui/img/people_icon.png" alt="">
			 ...
			 <div class="item col-mob-12 col-xs-6 col-sm-6 col-md-3">
				 <div class="tour-block tour-block-s-2 radius-5 hover-blue">
						 <div class="tour-layer delay-1"></div>
						 <img class="center-image" src="ui/img/home_4/tour-block_2.jpg" alt="">
					 <div class="tour-caption">
						 <div class="vertical-align">
			 ...
			 <div class="item col-mob-12 col-xs-6 col-sm-6 col-md-3">
				 <div class="tour-block tour-block-s-2 radius-5 hover-blue">
						 <div class="tour-layer delay-1"></div>
						 <img class="center-image" src="ui/img/home_4/tour-block_3.jpg" alt="">
					 <div class="tour-caption">
						 <div class="vertical-align">
