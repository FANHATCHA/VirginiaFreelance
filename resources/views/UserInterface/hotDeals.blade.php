...
<html lang="en-US">
<head>
    <title>Viginia Freelance Property Agency | Hot Deals</title>
		<meta charset="utf-8">
  		...
  		<div class="container">
  			...
  			<div class="row">
  				...
  				<div class="col-xs-12 col-sm-8 col-md-9"></br>
					   ...
					   <div class="panel-heading"><center style="font-size:25px; font-weight:bold;"> {{ $deals->hotDealTitle }} </center></div>
					@include('inc.slider')
					 </div>
