...
<body class="no-overflow" data-color="theme-1">
     ...
     <div class="style-page">
        <div class="wrappers">
         ...
         <a href="index.html" class="site-logo"><img src="ui/img/theme-1/logo_dark.png" alt=""></a>
		      ...
		      <a href="#"><i></i></a>
			  	...
			  	<ul>
					...
					<li class="type-1"><a href="#">Pages<span class="fa fa-angle-down"></span></a>
						<ul class="dropmenu">
							<li><a href="#">About <span class="fa fa-chevron-right"></span></a>
                               <ul class="dropmenu">
									<li><a href="about_us.html">About us 1</a></li>
								    <li><a href="about_us_2.html">About us 2</a></li>
								</ul>
                            </li>
                            <li><a href="#">Service <span class="fa fa-chevron-right"></span></a>
                               <ul class="dropmenu">
									<li><a href="services.html">Services 1</a></li>
								    <li><a href="services_2.html">Services 2</a></li>
								</ul>
                            </li>
                            <li><a href="#">Gallery <span class="fa fa-chevron-right"></span></a>
                               <ul class="dropmenu">
                            ...
                            <li><a href="#">404 page <span class="fa fa-chevron-right"></span></a>
                               <ul class="dropmenu">
									<li><a href="404.html">Page 404 style 1</a></li>
								    <li><a href="404_2.html">Page 404 style 2</a></li>
								</ul>
                            </li>
                            <li><a href="#">Coming soon <span class="fa fa-chevron-right"></span></a>
                               <ul class="dropmenu">
                    ...
                    <li class="type-1"><a href="#">Shortcodes<span class="fa fa-angle-down"></span></a>
						<ul class="dropmenu">
                            ...
                            <li>
							  <a href="#">Listing Styles<span class="fa fa-chevron-right"></span></a>
								<ul class="dropmenu">
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide active" data-val="0">
						<div class="hover-blue black-hover h_100">
						  	<div class="clip">
							 	<div class="bg bg-bg-chrome act" style="background-image:url(img/home_4/slide_1.jpg)"></div>
						  	</div>
					...
					<div class="swiper-slide" data-val="1">
						<div class="hover-blue black-hover h_100">
						  	<div class="clip">
							 	<div class="bg bg-bg-chrome act" style="background-image:url(img/home_4/slide_2.jpg)"></div>
						  	</div>
						  	<div class="tour-layer delay-1"></div>
						  	<div class="vertical-top">
									<div class="weth-icon style-2 bg-blue-light radius-3 fr">
					...
					<div class="swiper-slide" data-val="2">
						<div class="hover-blue black-hover h_100">
							<div class="clip">
								<div class="bg bg-bg-chrome act" style="background-image:url(img/home_4/slide_3.jpg)"></div>
							</div>
						  	<div class="tour-layer delay-1"></div>
						  	<div class="vertical-top">
									<div class="weth-icon style-2 bg-blue-light radius-3 fr">
					...
					<div class="swiper-slide active" data-val="3">
						<div class="hover-blue black-hover h_100">
						  	<div class="clip">
							 	<div class="bg bg-bg-chrome act" style="background-image:url(img/home_4/slide_4.jpg)"></div>
					 	 	</div>
						  	<div class="tour-layer delay-1"></div>
						  	<div class="vertical-top">
									<div class="weth-icon style-2 bg-blue-light radius-3 fr">
					...
					<div class="swiper-slide active" data-val="4">
						<div class="hover-blue black-hover h_100">
						  	<div class="clip">
							 	<div class="bg bg-bg-chrome act" style="background-image:url(img/home_4/slide_5.jpg)"></div>
						  	</div>
						  	<div class="tour-layer delay-1"></div>
						  	<div class="vertical-top">
									<div class="weth-icon style-2 bg-blue-light radius-3 fr">
				...
				<div class="swiper-container" data-autoplay="0" data-loop="0" data-speed="1000" data-slides-per-view="responsive" data-mob-slides="1" data-xs-slides="2" data-sm-slides="4" data-md-slides="5" data-lg-slides="6" data-add-slides="6">
				 	<div class="swiper-wrapper">
					  	<div class="swiper-slide">
							<div class="tour-item">
								<div class="radius-top">
								 	<img src="img/home_4/tour_1.jpg" alt="">
								 	<div class="tour-weather"><img src="img/weather_icon_small_blue.png" alt="">+30<span class="sup">o</span>C</div>
								</div>
					  	...
					  	<div class="swiper-slide">
							<div class="tour-item">
								<div class="radius-top">
								 	<img src="img/home_4/tour_2.jpg" alt="">
								 	<div class="tour-weather"><img src="img/weather_icon_small_blue.png" alt="">+25<span class="sup">o</span>C</div>
								</div>
								<div class="tour-desc bg-white">
					  	...
					  	<div class="swiper-slide">
							<div class="tour-item">
								<div class="radius-top">
								 	<img src="img/home_4/tour_3.jpg" alt="">
								 	<div class="tour-weather"><img src="img/weather_icon_rain_blue.png" alt="">+18<span class="sup">o</span>C</div>
								</div>
								<div class="tour-desc bg-white">
					  	...
					  	<div class="swiper-slide">
							<div class="tour-item">
								<div class="radius-top">
								 	<img src="img/home_4/tour_4.jpg" alt="">
								 	<div class="tour-weather"><img src="img/weather_icon_small_blue.png" alt="">+34<span class="sup">o</span>C</div>
								</div>
								<div class="tour-desc bg-white">
					  	...
					  	<div class="swiper-slide">
							<div class="tour-item">
								<div class="radius-top">
								 	<img src="img/home_4/tour_5.jpg" alt="">
								 	<div class="tour-weather"><img src="img/weather_icon_small_blue.png" alt="">+30<span class="sup">o</span>C</div>
								</div>
								<div class="tour-desc bg-white">
					  	...
					  	<div class="swiper-slide">
							<div class="tour-item">
								<div class="radius-top">
								 	<img src="img/home_4/tour_6.jpg" alt="">
								 	<div class="tour-weather"><img src="img/weather_icon_rain_blue.png" alt="">+22<span class="sup">o</span>C</div>
								</div>
								<div class="tour-desc bg-white">
									<h4><a class="tour-title color-dark-2 link-blue" href="#">mauritius</a></h4>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-8 col-sm-offset-2">
					<div class="second-title">
    					<h2>rest in paradise</h2>
    					<p class="color-grey">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, consequat.</p>
    				</div>
				</div>
			</div>
			<div class="row isotope-container">
				...
				<div class="item col-xs-12 col-md-6">
					<div class="tour-block tour-block-s-2 radius-5 hover-blue">
				     	<div class="tour-layer delay-1"></div>
					  	<img class="center-image" src="img/home_4/tour-block_1.jpg" alt="">
						<div class="tour-caption">
							<div class="vertical-align">
								<h3 class="hover-it">FOUR SEASONS hotel</h3>
								  <div class="rate">
									<span class="fa fa-star color-yellow"></span>
									<span class="fa fa-star color-yellow"></span>
									<span class="fa fa-star color-yellow"></span>
			    ...
			    <div class="item col-xs-12 col-md-6">
					<div class="tour-block tour-block-s-4 radius-5 underline-block hover-blue">
					    <div class="tour-layer delay-1"></div>
						<img class="center-image" src="img/home_4/tour-block_4.jpg" alt="">
						<div class="tour-caption">
						    <div class="vertical-top">
							...
							<div class="vertical-align">
								...
								<h3 class="underline hover-it">madagascar</h3>
								<h4>From <b>$600</b></h4>
								<p class="color-white-light">Cursus libero purus ac cursus ut sed.Nunc cursus libero purus ac congue arcu cursus ut sed vitae pulvinar massa idporta nequetiam.</p>
							</div>
							<div class="vertical-bottom">
							<div class="fl">
								<div class="tour-info">
									<img src="img/people_icon.png" alt="">
									  <span class="font-style-2 color-grey-4"><b class="color-white">2</b> adults, <b class="color-white">1</b> kids</span>
								</div>
								<div class="tour-info">
									<img src="img/calendar_icon.png" alt="">
									  <span class="font-style-2 color-grey-4">July<b class="color-white"> 19th</b> to July<b class="color-white"> 26th</b></span>
								</div>
							   </div>
								<a href="#" class="c-button b-50 fr bg-white"><span>view more</span></a>
							</div>
						</div>
					</div>
			    </div>
				<div class="item col-mob-12 col-xs-6 col-sm-6 col-md-3">
					<div class="tour-block tour-block-s-2 radius-5 hover-blue">
				     	<div class="tour-layer delay-1"></div>
					  	<img class="center-image" src="img/home_4/tour-block_2.jpg" alt="">
						<div class="tour-caption">
							<div class="vertical-align">
								<h3 class="hover-it">dubai</h3>
								  <div class="rate">
									<span class="fa fa-star color-yellow"></span>
									<span class="fa fa-star color-yellow"></span>
									<span class="fa fa-star color-yellow"></span>
				...
				<div class="item col-mob-12 col-xs-6 col-sm-6 col-md-3">
					<div class="tour-block tour-block-s-2 radius-5 hover-blue">
				     	<div class="tour-layer delay-1"></div>
					  	<img class="center-image" src="img/home_4/tour-block_3.jpg" alt="">
						<div class="tour-caption">
							<div class="vertical-align">
								<h3 class="hover-it">miami</h3>
								  <div class="rate">
									<span class="fa fa-star color-yellow"></span>
									<span class="fa fa-star color-yellow"></span>
									<span class="fa fa-star color-yellow"></span>
        ...
        <div class="map-form">
        	<div class="container">
        		<div class="table-view">
					<div class="cell-view">
						<form>
			        		<h4 class="map-title">looking for some activities?</h4>
			        		<p class="map-text">Curabitur nunc erat, consequat in erat ut, congue bibendum nulla. Suspendisse id pharetra lacus, et hendrerit mi quis leo elementum. Lorem ipsum dolor sit amet</p>
			        		<div class="row">
			        			<div class="col-xs-12 col-sm-8">
			        				<div class="input-style-1">
										<img src="img/loc_icon_small.png" alt="">
									  	<input type="text" required="" placeholder="Enter a destination or hotel name">
									</div>
			        			</div>
			        			<div class="col-xs-12 col-sm-4">
			        				<div class="submit">
								   		<input class="c-button b-60 bg-white" type="submit" value="search now">
									</div>
			        			</div>
			        		</div>
		        		</form>
				  ...
				  <div class="swiper-wrapper">
					<div class="swiper-slide" data-val="0">
					   <div class="offers-block style-2 radius-mask underline-block hover-blue">
						 ...
						 <div class="vertical-top">
						   <div class="rate">
							<span class="fa fa-heart color-blue"></span>
							<span class="fa fa-heart color-blue"></span>
							<span class="fa fa-heart color-blue"></span>
							<span class="fa fa-heart color-blue"></span>
							<span class="fa fa-heart color-blue"></span>
		...
		<div class="wide-container clearfix">
			<div class="left-title">
				<div class="second-title">
					...
					<h2 class="color-white underline">all sea tours</h2>
					<p class="color-white-light">Curabitur nunc erat, lacus, et hendrerit mi quis leo dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adipiscing.</p>
				</div>
			</div>
						  ...
						  <div class="swiper-wrapper">
						      <div class="swiper-slide">
						          <div class="hotel-item style-3">
						          	 <div class="radius-top">
						          	 	<img src="img/home_4/area_tours_01.jpg" alt="">
						             ...
						             <span class="f-14 people"><strong>2</strong> adults, <strong>1</strong> kids</span>
						             ...
						             <a href="#" class="c-button b-40 bg-blue hv-blue-o ">view more</a>
						             <a href="#" class="c-button b-40 bg-blue-t hv-blue b-1 fr">book now</a>
						             </div>
						          </div>
							  </div>
							  <div class="swiper-slide">
						          <div class="hotel-item style-3">
						          	 <div class="radius-top">
						          	 	<img src="img/home_4/area_tours_02.jpg" alt="">
							  ...
							  <div class="swiper-slide">
						          <div class="hotel-item style-3">
						          	 <div class="radius-top">
						          	 	<img src="img/home_4/area_tours_03.jpg" alt="">
						          	 	<div class="price price-s-2">$273</div>
										<div class="tour-weather"><img src="img/weather_icon_small_blue.png" alt="">+30<span class="sup">o</span>C</div>
						          	 </div>
						          	 <div class="title clearfix">
							  ...
							  <div class="swiper-slide">
						          <div class="hotel-item style-3">
						          	 <div class="radius-top">
						          	 	<img src="img/home_4/area_tours_04.jpg" alt="">
						          	 	<div class="price price-s-2">$273</div>
										<div class="tour-weather"><img src="img/weather_icon_small_blue.png" alt="">+30<span class="sup">o</span>C</div>
						          	 </div>
						          	 <div class="title clearfix">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-8 col-sm-offset-2">
					<div class="second-title">
    					...
    					<p class="color-grey">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, ex ea commodo consequat.</p>
    				</div>
				</div>
			</div>
			<div class="row isotope-container">
							  	...
							  	<div class="swiper-wrapper">
									<div class="swiper-slide" data-val="0">
										<div class="tour-block tour-block-s-6 radius-5 underline-block hover-blue">
										    <div class="tour-layer delay-1"></div>
											<img class="center-image"  src="img/home_4/propose_1.jpg" alt="">
											<div class="tour-caption">
												<div class="vertical-align">
													<h4>best offer</h4>
				...
				<div class="item col-xs-12 col-md-6">
					<div class="tour-block tour-block-s-7 radius-5 underline-block hover-blue">
				     	<div class="tour-layer delay-1"></div>
					  	<img class="center-image" src="img/home_4/propose_2.jpg" alt="">
						<div class="tour-caption">
							<div class="vertical-align">
                   ...
                   <div class="footer-block">
                     <h6>Contact Info</h6>
                       <div class="contact-info">
						...
						<div class="contact-line color-grey-3"><i class="fa fa-envelope-o"></i><a href="mailto:"><span class="__cf_email__" data-cfemail="600c05141314120116050c200d01090c4e030f0d">[email&#160;protected]</span></a></div>
						<div class="contact-line color-grey-3"><i class="fa fa-globe"></i><a href="#">let’<span class="__cf_email__" data-cfemail="67143813150611020b271008150b034904080a">[email&#160;protected]</span></a></div>
...
<script data-cfasync="false" src="ui/cdn-cgi/scripts/af2821b0/cloudflare-static/email-decode.min.js"></script><script src="js/jquery-2.1.4.min.js"></script>
